var DISQUS = function (a) {
    "use strict";
    var b = a.DISQUS || {}, c = [];
    return b.define = function (d, e) {
        "function" == typeof d && (e = d, d = "");
        for (var f = d.split("."), g = f.shift(), h = b, i = (e || function () {
                return {}
            }).call({
                overwrites: function (a) {
                    return a.__overwrites__ = !0, a
                }
            }, a); g;) h = h[g] ? h[g] : h[g] = {}, g = f.shift();
        for (var j in i) i.hasOwnProperty(j) && (!i.__overwrites__ && null !== h[j] && h.hasOwnProperty(j) && b.logError && b.logError("Unsafe attempt to redefine existing module: " + j), h[j] = i[j], c.push(function (a, b) {
            return function () {
                delete a[b]
            }
        }(h, j)));
...
DISQUS.define(function (a, b) {
    ...
    c.getUid = function (a) {
        ...
        if (b && (a += ~a.indexOf("?") ? "&" == a.charAt(a.length - 1) ? "" : "&" : "?", a += c.serializeArgs(b)), d) {
            var e = {};
    ...
    var a = function (a, b) {
        ...
        return !1
            ...
            var d = DISQUS.config && DISQUS.config.switches;
            if (!d) return null;
            if (DISQUS.isOwn(b, c)) return b[c];
            var e = b[c] = a(d, c);
            return e
        }, d = function () {
            window.console && c("next_logging") !== !1 && (window.console.log.apply ? window.console.log.apply(window.console, arguments) : window.console.log(Array.prototype.slice.call(arguments, 0).join(" ")))
        }, e = function () {
            var a = Array.prototype.slice.call(arguments, 0);
            DISQUS.log.apply(DISQUS, a), e.ravenEnabled && Raven.captureMessage({
                name: "DISQUS.logError",
                message: a.join(" ")
            })
        };
    return e.ravenEnabled = !1, {
        log: d,
        logError: e
    }
    ...
    function c(a) {
        return g.getElementById(a) || g.body || g.documentElement
    }
    ...
    var g = a.document,
        h = "2",
        i = {}, j = DISQUS.use("JSON");
    if (!DISQUS.version || DISQUS.version() !== h) {
        var k = DISQUS.isOwn;
        d(a, "message", function (a) {
            var c;
            for (var d in i)
                if (k(i, d) && a.origin == i[d].origin) {
                    c = !0;
                    break
                }
            if (c) {
                var e = j.parse(a.data),
                    f = i[e.sender];
                switch (f || b("Message from our server but with invalid sender UID:", e.sender), e.scope) {
                case "host":
                    f.trigger(e.name, e.data);
                    break;
                default:
                    b("Message", e.scope, "not supported. Sender:", a.origin)
                }
            }
        }, !1), d(a, "hashchange", function () {
            DISQUS.trigger("window.hashchange", {
                hash: a.location.hash
            })
        }, !1), d(a, "resize", function () {
            DISQUS.trigger("window.resize")
        }, !1);
        var l = function () {
            DISQUS.trigger("window.scroll")
        };
        d(a, "scroll", f(l, 250, 50)), d(g, "click", function () {
            DISQUS.trigger("window.click")
        });
        var m = function (a) {
            a = a || {}, this.state = m.INIT, this.uid = a.uid || DISQUS.getUid(), this.origin = a.origin, this.target = a.target, this.window = null, i[this.uid] = this, this.on("ready", function () {
                this.state = m.READY
        ...
        DISQUS.extend(m, {
            ...
            READY: 1,
            KILLED: 2
        }), DISQUS.extend(m.prototype, DISQUS.Events), m.prototype.sendMessage = function (a, b) {
            var c = j.stringify({
                scope: "client",
                name: a,
                data: b
        ...
        }, m.prototype.hide = function () {}, m.prototype.show = function () {}, m.prototype.url = function () {
            return DISQUS.serialize(this.target, {
                disqus_version: "1382133232"
            }) + "#" + this.uid
        }, m.prototype.destroy = function () {
            this.state = m.KILLED, this.off()
        }, m.prototype.isReady = function () {
            return this.state === m.READY
        }, m.prototype.isKilled = function () {
            return this.state === m.KILLED
        };
        var n = function (a) {
            m.call(this, a), this.windowName = a.windowName
        };
        DISQUS.extend(n.prototype, m.prototype), n.prototype.load = function () {
            this.window = a.open("", this.windowName || "_blank"), this.window.location = this.url()
        }, n.prototype.isKilled = function () {
            return m.prototype.isKilled() || this.window.closed
        };
        var o = function (a) {
            m.call(this, a), this.styles = a.styles || {}, this.role = a.role || "application", this.container = a.container, this.elem = null
        };
        DISQUS.extend(o.prototype, m.prototype), o.prototype.load = function () {
            var a = this.elem = g.createElement("iframe");
            a.setAttribute("id", "dsq" + this.uid), a.setAttribute("data-disqus-uid", this.uid), a.setAttribute("allowTransparency", "true"), a.setAttribute("frameBorder", "0"), this.role && a.setAttribute("role", this.role), this.setInlineStyle(this.styles)
        }, o.prototype.getOffset = function (a) {
            a = a || g.documentElement;
            for (var b = this.elem, c = b, d = 0, e = 0; c && c !== a;) d += c.offsetLeft, e += c.offsetTop, c = c.offsetParent;
            return {
                top: e,
                left: d,
        ...
        }, o.prototype.setInlineStyle = function (a, b) {
            var c = {};
        ...
        }, o.prototype._setInlineStyleCompat = function (a) {
            ...
            m.prototype.destroy.call(this), this.elem && this.elem.parentNode && this.elem.parentNode.removeChild(this.elem)
        };
        var p = function (a) {
            var b = this;
            o.call(b, a), b.styles = DISQUS.extend({
                width: "100%",
                border: "none",
                overflow: "hidden",
                height: "0"
        ...
        DISQUS.extend(p.prototype, o.prototype), p.prototype.load = function (a) {
            var b = this;
            o.prototype.load.call(b);
            var e = b.elem;
            e.setAttribute("width", "100%"), e.setAttribute("src", this.url()), d(e, "load", function () {
                b.window = e.contentWindow, a && a()
            });
            var f = DISQUS.isString(this.container) ? c(this.container) : this.container;
            f.appendChild(e)
        };
        var q = function (a) {
            o.call(this, a), this.contents = a.contents || "", this.styles = DISQUS.extend({
                width: "100%",
                border: "none",
                overflow: "hidden"
            }, a.styles || {})
        ...
        DISQUS.extend(q.prototype, o.prototype), q.prototype.load = function () {
            o.prototype.load.call(this);
            var a = this.elem;
            a.setAttribute("scrolling", "no");
            var b = DISQUS.isString(this.container) ? c(this.container) : this.container;
            ...
            d(b, "click", function (b) {
                a(b)
            })
        };
        var r = DISQUS.extend({}, DISQUS.Events);
        return {
            version: function () {
                return h
            },
    ...
    "use strict";
    var a = new DISQUS.Sandbox({
        container: "disqus_thread",
        contents: "<!doctype html><html><head><script>window.JSON=JSON</script></head></html>",
        styles: {
            display: "none"
        }
    }).load().window,
        b = a.JSON;
    if (!b) throw new Error("Cannot get JSON namespace from sandbox.");
    return {
    ...
    function g() {
        for (var a = u.getElementsByTagName("h1"), c = u.title, d = c.length, e = c, g = .6, h = 0; h < a.length; h++)! function (a) {
    ...
    function h(b, c, d) {
        var e;
        return d = d || c, b === u ? "" : (a.getComputedStyle ? e = u.defaultView.getComputedStyle(b, null).getPropertyValue(c) : b.currentStyle && (e = b.currentStyle[c] ? b.currentStyle[c] : b.currentStyle[d]), "transparent" == e || "" === e || "rgba(0, 0, 0, 0)" == e ? h(b.parentNode, c, d) : e || null)
    }

    function i(a) {
        a.match("^rgb") && (a = j(a).substr(1));
    ...
    function l(a) {
        ...
        return b.href = +new Date, k(a, b, "color")
    }
    ...
    function n(a) {
        for (var b, c = k(a, "span", "font-family", "fontFamily"), d = c.split(","), e = {
            ...
            if (b = m(d[f]), e.hasOwnProperty(b)) return !0;
        return !1
    }
    ...
    function r(a) {
        (new Image).src = DISQUS.serialize(t + "/stat.gif", {
            event: a
        })
    }
    ...
    var t = "//juggler.services.disqus.com",
        u = a.document;
    return {
    ...
    c(g.prototype, DISQUS.Events), g.prototype.destroy = function () {
        var a = this.constructor;
        this.off(), this.stopListening(), a.unregister && a.unregister(this)
    }, g.extend = function (a, d) {
        var e, f = this;
    ...
    var h = g.extend({
        ...
        state: null,
        origins: {
            insecure: "http://disqus.com",
            secure: "https://disqus.com"
        },
        getUrl: function () {
            return this.settings.useSSL ? this.urls.secure : this.urls.insecure
        },
        getFrame: function () {
            var a, b = this.settings,
                c = {
                    target: this.getUrl(),
                    origin: b.useSSL ? this.origins.secure : this.origins.insecure,
                    uid: this.uid
                };
            return b.windowName ? c.windowName = b.windowName : c.container = this.settings.container || document.body, this.getFrameSettings && (c = this.getFrameSettings(c)), a = c.windowName ? DISQUS.Popup : DISQUS.Channel, new a(c)
        },
        setState: function (a) {
            var b = this.constructor;
            return a in b.states ? (this.state = b.states[a], void 0) : !1
        },
        init: function () {
            var a, b = this;
        ...
        destroy: function () {
            var a = this.frame;
            a && (this.stopListening(a), a.destroy()), this.setState("KILLED"), this.frame = null, g.prototype.destroy.call(this)
        },
        events: {
    ...
    var i = h.extend({
        getUrl: function () {
            var b = this.settings,
                c = h.prototype.getUrl.call(this),
                d = {
                    f: b.forum,
                    t_i: b.identifier,
            ...
            return b.unsupported && (d.n_s = b.unsupported), DISQUS.serialize(c, d)
        },
        getFrameSettings: function (a) {
            return a.role = "complementary", a
        },
        getFrameInitParams: function (b, c) {
            ...
            return c.elem && a.navigator.userAgent.match(/(iPad|iPhone|iPod)/) && (e.width = c.elem.offsetWidth), e.initialPosition = this.getViewportAndScrollStatus(), e
        },
        configureScrollEvent: function () {
            var a = this,
                b = this.scrollContainer = this.getScrollContainer();
            b === e ? a.listenTo(DISQUS, "window.scroll", a.communicateViewportAndScrollStatus) : DISQUS.addEvent(b, "scroll", a.throttledCommunicateViewportAndScrollStatus)
        },
        getScrollContainer: function () {
            if (!this.settings.enableScrollContainer) return e;
            for (var a = this.settings.container; a.parentNode && a !== e;) {
                a = a.parentNode;
        ...
        getViewportCoords: function () {
            return this.scrollContainer === e ? this.getWindowCoords() : this.getScrollContainerCoords()
        },
        ...
        getViewportAndScrollStatus: function () {
            ...
            return {
                frameOffset: a.getOffset(this.scrollContainer),
                pageOffset: b.top,
                height: b.height
            }
        },
        throttledCommunicateViewportAndScrollStatus: DISQUS.throttle(function () {
        ...
        events: {
            beforeInit: function () {
                this.settings.unsupported || this.settings.windowName || (this.configureScrollEvent(), this.listenTo(DISQUS, "window.resize", this.throttledCommunicateViewportAndScrollStatus))
            },
            afterInit: function () {
            ...
            "frame:resize": function (a, b) {
                b.elem && this.rendered && (b.setInlineStyle("height", a.height + "px"), b.sendMessage("embed.resized")), this.communicateViewportAndScrollStatus()
            },
            ...
            "frame:scrollTo": function (b, c) {
                if (c.elem && c.getOffset) {
                    var d = c.getOffset(),
                        e = "window" === b.relative ? b.top : d.top + b.top,
                        f = this.getViewportCoords();
                    !b.force && e > f.pageYOffset && e < f.pageYOffset + f.innerHeight || (this.scrollContainer === document.documentElement ? a.scrollTo(0, e) : this.scrollContainer.scrollTop = e)
                }
            }
        }
    }),
    ...
    "use strict";
    var b = DISQUS.next.host.app.WindowedApp,
        c = b.extend({
            urls: {
                insecure: "http://disqus.com/embed/profile/",
                secure: "https://disqus.com/embed/profile/"
            },
            events: {
                beforeInit: function () {
                    var a = this.settings;
            ...
            getUrl: function () {
                var a = this.settings,
                    c = b.prototype.getUrl.call(this);
                return DISQUS.serialize(c, {
                    f: a.forum,
                    l: a.language
                })
            },
            ...
            show: function (a) {
                ...
                var b = this.frame;
                return b.isReady() ? (b.sendMessage("showProfile", a), b.show(), void 0) : void this.once("frame:ready", function () {
                    this.show(a)
                }, this)
            }
        });
    ...
    return DISQUS.extend(c.prototype, {
        ...
        setCredentials: function (a, b, c) {
            return a && b ? (c || (localStorage.setItem(d, a), localStorage.setItem(e, b)), this.credentials = {
                channel: a,
                messageUrl: b
            }, void 0) : void this.clearCredentials()
        },
    ...
    var b = a.document,
        ...
        g = f.extend({
            ...
            urls: {
                insecure: "http://disqus.com/embed/comments/",
                secure: "https://disqus.com/embed/comments/"
            },
            events: {
                beforeInit: function () {
                    var a = this.settings,
                        b = !a.windowName;
                    a.unsupported || (this.indicators = {}, b && this.addLoadingAnim(), this.bindPublisherCallbacks(), this.forwardGlobalEvents())
                },
                ...
                "frame:realtime.init": function (a, b) {
                    if (b.getOffset) {
                        for (var c, d, e = ["north", "south"], f = b.getOffset().width + "px", g = {
                                width: f,
                                minWidth: f,
                                maxWidth: f,
                                position: "fixed"
                            ...
                            }, i = 0; i < e.length; i++) d = e[i], c = new DISQUS.Sandbox({
                            uid: "-indicator-" + d,
                            container: this.settings.container,
                            contents: a[d].contents,
                            styles: DISQUS.extend(h[d], g),
                            role: "alert"
                        }), c.load(), c.hide(),
                        function (a) {
                            c.click(function () {
                                b.sendMessage("realtime.click", a)
                            })
                        }(d), this.indicators[d] = c;
                        this.on({
                            "frame:realtime.showNorth": function (a) {
                                var b = this.indicators.north;
                                b.document.getElementById("message").innerHTML = a, b.show()
                            },
                            "frame:realtime.hideNorth": function () {
                                this.indicators.north.hide()
                            },
                            "frame:realtime.showSouth": function (a) {
                                var b = this.indicators.south;
                                b.document.getElementById("message").innerHTML = a, b.show()
                            },
                            "frame:realtime.hideSouth": function () {
                                this.indicators.south.hide()
                            }
                        }, this)
                    }
                },
                ...
                fail: function (a) {
                    e.utils.logStat("failed_embed.server." + a.code)
                },
                "loading.done": function () {
                    this.setState("RUNNING"), this.triggeredSlowEvent && e.utils.logStat("rendered_embed.slow")
                }
            },
            onceEvents: {
                "frame:loadLinkAffiliator": function (b, c) {
                    var d = function () {
                        for (var b in a)
                    ...
                    if (!(a.vglnk_self || a.vglnk || d())) {
                        ...
                        null != b.clientUrl && null != e && null != f && null != b.id && (this.listenForAffiliationRequests(e, f, g), DISQUS.define("vglnk", function () {
                            return {
                                ...
                                sub_id: g,
                                onlibready: function () {
                                    c.sendMessage("affiliationOptions", {
            ...
            listenForAffiliationRequests: function (a, b, c) {
                var d = this.frame;
                this.on("frame:affiliateLink", function (e) {
                    function f(a) {
                        return function (b) {
                            var c = {
                                token: a
                            };
                            b && (c.url = b), d.sendMessage("affiliateLink", c)
                        }
                    }
                    var g = DISQUS.vglnk.$;
                    return g ? (g.request(a + "/click", {
                        format: "jsonp",
                        out: e.url,
                        key: b,
                        loc: d.target,
                        ...
                        fn: f(e.token),
                        timeout: DISQUS.vglnk.opt("click_timeout")
                    }), void 0) : void d.sendMessage("affiliateLink")
                })
            },
            ...
            removeLoadingAnim: function () {
                ...
                this.timeout && (clearTimeout(this.timeout), this.timeout = null), a && a.parentNode === b && (b.removeChild(a), this.loadingElem = null)
            },
            destroy: function () {
                var a = this.indicators;
                this.removeLoadingAnim(), this.profile && this.profile.destroy(), a && a.north && (a.north.destroy(), a.north = null), a && a.south && (a.south.destroy(), a.south = null), f.prototype.destroy.call(this)
            }
        }, {
    ...
    return e.app.expose(g, ["list", "listByKey", "get"], h), {
        Lounge: h
    }
}), DISQUS.define("next.host.ignition", function () {
    "use strict";
    var a = DISQUS.next.host,
        b = a.app.ThreadBoundApp,
        c = a.lounge.Lounge,
        d = b.extend({
            urls: {
                insecure: "http://disqus.com/embed/ignition/",
                secure: "https://disqus.com/embed/ignition/"
            },
            events: {
                afterInit: function () {
                    var b = this,
                        c = -1 !== navigator.userAgent.indexOf("MSIE"),
                        d = -1 !== navigator.userAgent.indexOf("MSIE");
                    if (d || c) {
                        var e = b.overlay = document.createElement("a"),
                            f = a.lounge.Lounge(this.settings);
                        e.setAttribute("href", f.getUrl()), e.setAttribute("target", "_blank"), e.style.cssText = ["display: block !important", "float: left !important", "position: relative !important", "padding: 0 !important", "margin; 0 !important", "width: 100% !important", "opacity: 0 !important", "height: 0 !important", "z-index: 1 !important", "cursor: pointer !important"].join(";"), c && e.addEventListener("click", function (a) {
                            a.preventDefault(), b.trigger("frame:ignite", {
                                windowName: "disqus_" + DISQUS.getUid() + "_" + (new Date).getTime()
                            })
                        }, !1), b.on("frame:resize", function (a) {
                            var c = b.overlay,
                                d = a.button;
                            c.style.setProperty("height", d.height + "px", "important"), c.style.setProperty("margin-top", "-" + (a.height - d.top) + "px", "important")
                        }, b), b.frame.elem.parentNode.appendChild(e)
                    }
                },
                "frame:ignite": function (a) {
                    var b = this.lounge;
                    b && !b.frame.isKilled() && b.destroy();
                    var d = DISQUS.extend({
                        windowName: a.windowName
                    }, this.settings);
                    this.lounge = b = c(d), b.init()
                }
            }
        }),
        e = function (a) {
    ...
    return e.getContainer = function () {
        ...
        return this.getValuesFromGlobals(), {
            ...
            useSSL: c.isSSL(a.location.protocol),
            language: b.language,
    ...
    var b, c = DISQUS.use("next.host.loader"),
        ...
        f = !1,
        g = function (a, b) {
            return !b.unsupported && (a.disqus_ignition || "")
        }, h = function () {
            var b = a.document;
            if (b.getElementsByClassName) {
                if ("complete" !== b.readyState) return DISQUS.addEvent(a, "load", h);
            ...
            e.configurator = g;
            var h = e.toJSON();
            return f || (h.container.innerHTML = "", f = !0), b = c.shouldUseIgnition(a, h) ? d.ignition.Ignition(h) : d.lounge.Lounge(h), b.init(), c.removeDisqusLink(), b
        }, j = function (a) {
